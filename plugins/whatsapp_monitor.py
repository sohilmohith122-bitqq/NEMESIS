...
def _generate_dynamic_reply(sender, message):
    if not _GENAI_AVAILABLE:
        return f"Hello, I am Nemesis, Sohil's AI assistant. He is currently busy. I will inform him that you messaged."
    ...
    try:
        ...
        prompt = (
            f"You are Nemesis, Sohil's personal AI assistant. Sohil is currently busy working. "
            f"You received a WhatsApp message from '{sender}' which says: '{message}'. "
            f"Write a short, natural, and polite reply on Sohil's behalf. "
            f"Acknowledge what they said. If it is an important update (like a meeting, emergency, or request), "
            f"tell them you will convey it to Sohil immediately. "
        ...
        return f"Hello, I am Nemesis. Sohil is currently busy, but I will convey your message to him."
            ...
            try:
                ...
                for notif in notifications:
                    ...
                    if notif_id not in _replied_notification_ids:
                        ...
                        # 4. Notify Sohil via NEMESIS UI
                        alert_msg = f"Sohil, '{sender}' sent you a message: '{message}'. I replied with: '{reply_text}'"
                        if player:
                            ...
                            if hasattr(player, 'on_text_command') and callable(player.on_text_command):
                                internal_memory = (
                                    ...
                                    f"Keep this in your memory. DO NOT speak or reply to this alert out loud unless Sohil explicitly asks if you sent any messages."
                                )
                                try:
